...
class DataBase {
  ...
  private function __construct() {
    $this->mysqli = new mysqli("localhost", "root", "root", "avito-billing");
  ...
  /* Методы (INSERT, UPDATE, DELETE). Если запрос INSERT, то возвращается id последней вставленной записи */
